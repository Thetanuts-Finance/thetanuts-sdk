...
async function main() {
  ...
  const systemPrompt = [
    ...
    '3. If no open position: choose a strike + expiry and call prepare_request_rfq with',
    ...
    '   our reserve, call prepare_settle_rfq_early with the offerorAddress.',
    '6. If 30 minutes have passed with no acceptable offer, call prepare_cancel_rfq.',
    '',
