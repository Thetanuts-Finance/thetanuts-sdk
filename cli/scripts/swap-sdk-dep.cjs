 ...
 *
 * Wired into `cli/package.json` via the `prepublishOnly` script. Runs
...
if (!currentDep) {
  console.error(`[swap-sdk-dep] ERROR: ${SDK_NAME} not in cli dependencies`);
  process.exit(1);
}
...
cli.dependencies[SDK_NAME] = newDep;
